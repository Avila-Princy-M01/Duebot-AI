...
interface AuditInteractiveProps {
  initialRows: AuditRow[];
  initialTotalCount: number;
  initialVerification: AuditVerification | null;
}
...
export function AuditInteractive({
  ...
  // Only re-fetch if filters or pagination changed from initial state
  useEffect(() => {
    if (selectedState || selectedActor || invoiceSearch || offset !== 0 || limit !== 50) {
      loadAudit();
    }
  }, [loadAudit, selectedState, selectedActor, invoiceSearch, offset, limit]);
