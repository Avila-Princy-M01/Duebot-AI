...
2. **Intentional Under-Dunning on Chronic Recalcitrants ($T \ge 4$)**: On cohorts requiring $\ge 4$ touches to convert, an unconstrained 12-touch blind loop recovers 1.8% to 2.3% more cash by brute-force dunning. DueBot **intentionally under-duns** these accounts: its hard 3-touch sequence cap halts automated bot outreach and escalates to a human collections specialist. In regulated B2B payments, automated harassment beyond 3 touches is a compliance and customer-relationship liability.
