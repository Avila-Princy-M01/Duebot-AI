...
2. **How is the baseline comparison evaluated fairly?**
   ...
   * **Incremental Recovery Lift (+4.93% ± 3.93%, +₹ 4.76L vs No-Agent)**: DueBot captures +4.93% higher recovery (t = +3.96, p = 0.0033, exact sign test p = 0.0039) than organic self-cure by actively recovering receivables from responsive debtors.
   ...
   * **Recovery Rate Parity vs Naive (+0.77% ± 1.15%, 95% CI: [-0.05%, +1.60%])**: **5 wins, 0 losses, 5 ties** (t = +2.12, p = 0.0626, exact sign test p = 0.0625). DueBot is never worse than a blind loop on any seed, matching or exceeding recovery while eliminating spam.
   * **Faster and Quieter (-0.50 ± 0.10 days, p < 0.001)**: Across identical portfolios, DueBot's 3-day adaptive interval consistently accelerates resolution by 12 hours (95% CI: [-0.57d, -0.43d], t = -15.71, p < 0.001, exact sign test p = 0.0020) while sending fewer total touches.
