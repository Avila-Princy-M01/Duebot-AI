...
1. **Incremental Cash Recovery (+4.9pp / +₹4.76L vs No-Agent)**: DueBot captures **$+4.93\% \pm 3.93\%$ higher recovery** ($+₹4,76,342 \pm ₹4,28,090$, paired $t = +3.96, p < 0.01$, exact sign test $p = 0.0215$) over organic self-cure by proactively recovering receivables from responsive buyers.
